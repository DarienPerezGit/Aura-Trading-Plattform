> **DOCUMENTO HISTÓRICO — PROTOTIPO V0**
> Este documento describe el prototipo visual inicial (Dash terminal, sin ejecución).
> El sistema activo sigue la arquitectura de 4 capas institucional descrita en [README.md](../README.md).

---

# Aura Terminal — Plan MVP (v0 — Prototipo Visual)
